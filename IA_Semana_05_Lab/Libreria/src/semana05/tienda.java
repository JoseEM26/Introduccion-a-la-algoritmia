...
public class tienda extends JFrame implements ActionListener {
	...
	public tienda() {
		...
		setTitle("Sueldo de las familias");
		...
		txtHoras.setBackground(new Color(204, 204, 255));
		txtHoras.setColumns(10);
		txtHoras.setBounds(103, 33, 86, 20);
		contentPane.add(txtHoras);
		
		txtHijos = new JTextField();
		txtHijos.setBackground(new Color(204, 204, 255));
		...
		btnprocesar.setBounds(305, 7, 119, 23);
		...
		btnEliminar.setBounds(305, 32, 113, 23);
		contentPane.add(btnEliminar);
		
		cboCAtegorias = new JComboBox();
		cboCAtegorias.setBackground(new Color(204, 204, 255));
