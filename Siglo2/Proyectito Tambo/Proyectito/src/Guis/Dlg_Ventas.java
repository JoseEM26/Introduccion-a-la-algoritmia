...
public class Dlg_Ventas extends JDialog {
	...
	public Dlg_Ventas() {
		...
		btnNewButton.setBounds(504, 11, 89, 23);
		...
		txtComprarCodigo.setBounds(408, 12, 86, 20);
		...
		lblCodigo.setBounds(302, 15, 116, 14);
