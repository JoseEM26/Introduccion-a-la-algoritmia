...
public class Dlg_Productos extends JDialog {
	...
	public Dlg_Productos() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel_1.setBounds(10, 74, 98, 14);
			contentPanel.add(lblNewLabel_1);
		}
		{
			JLabel lblNewLabel_2 = new JLabel("nombre");
			lblNewLabel_2.setForeground(new Color(255, 255, 255));
			lblNewLabel_2.setBounds(10, 99, 62, 14);
			contentPanel.add(lblNewLabel_2);
		}
		{
			JLabel lblNewLabel_3 = new JLabel("precio");
			lblNewLabel_3.setForeground(new Color(255, 255, 255));
			lblNewLabel_3.setBounds(10, 124, 62, 14);
			contentPanel.add(lblNewLabel_3);
		}
		{
			JLabel lblNewLabel_4 = new JLabel("stockActual");
			lblNewLabel_4.setForeground(new Color(255, 255, 255));
			lblNewLabel_4.setBounds(10, 149, 62, 14);
			contentPanel.add(lblNewLabel_4);
		}
		{
			JLabel lblNewLabel_5 = new JLabel("stockMinimo");
			lblNewLabel_5.setForeground(new Color(255, 255, 255));
			lblNewLabel_5.setBounds(10, 174, 62, 14);
			contentPanel.add(lblNewLabel_5);
		}
		{
			txtcodigoProducto = new JTextField();
			txtcodigoProducto.setBounds(96, 68, 119, 20);
		...
		}
		{
			...
			txtNombre.setBounds(96, 96, 119, 20);
			contentPanel.add(txtNombre);
		}
		{
			txtPrecio = new JTextField();
			txtPrecio.setColumns(10);
			txtPrecio.setBounds(96, 121, 119, 20);
			contentPanel.add(txtPrecio);
		}
		{
			txtstockActual = new JTextField();
			txtstockActual.setColumns(10);
			txtstockActual.setBounds(96, 146, 119, 20);
			contentPanel.add(txtstockActual);
		}
		{
			txtstockMinimo = new JTextField();
			txtstockMinimo.setColumns(10);
			txtstockMinimo.setBounds(96, 171, 119, 20);
		...
		}
		{
			...
			btnIngreso.setBounds(436, 45, 89, 23);
		...
		}
		{
			...
			btnModificacion.setBounds(436, 70, 89, 23);
		...
		}
		{
			...
			btnConsulta.setBounds(436, 95, 89, 23);
		...
		}
		{
			...
			btnEliminacion.setBounds(436, 120, 89, 23);
		...
		}
		{
			...
			btnListado.setBounds(436, 145, 89, 23);
		...
		}
		{
			...
			btnExtraAgregar.setBounds(236, 38, 89, 23);
		...
		}
		{
			...
			btnExtraModificar.setBounds(337, 38, 89, 23);
		...
		btnSalir.setBounds(236, 70, 89, 23);
		contentPanel.add(btnSalir);
		
		scrollPaneTable = new JScrollPane();
		scrollPaneTable.setBounds(10, 224, 530, 112);
		...
		table.setModel(modelo);
		{
			...
			scrollPaneTable2.setBounds(10, 224, 530, 112);
		...
		btnConsulta_1.setBounds(236, 38, 89, 23);
		contentPanel.add(btnConsulta_1);
		
		lblDatoModicar = new JLabel("Dato Modificar");
		lblDatoModicar.setForeground(new Color(255, 255, 255));
		lblDatoModicar.setBounds(10, 49, 98, 14);
		...
		txtDatoModificar.setBounds(96, 43, 119, 20);
		contentPanel.add(txtDatoModificar);
		{
			...
			btnCambiar.setBounds(337, 38, 89, 23);
			contentPanel.add(btnCambiar);
		}
		{
			lblNewLabel = new JLabel("Productos");
			lblNewLabel.setForeground(new Color(255, 255, 255));
			lblNewLabel.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 33));
			lblNewLabel.setBounds(10, 4, 182, 32);
		...
		boolean activar=false;
			for(int i=0;i<apro.Tamano();i++) {
				if(LeerDatoCambiar()==apro.Obtener(i).getCodigoProducto()) {
					...
					txtcodigoProducto.setEditable(false);
					activar=true;
					txtcodigoProducto.setText(LeerDatoCambiar()+"");
