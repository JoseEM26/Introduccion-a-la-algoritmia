...
public class ModicarCeramica extends JDialog {
	...
	public ModicarCeramica() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Proyecto Algoritmia Ceramica\\img\\editar.png"));
		...
		cmbModelos.setModel(new DefaultComboBoxModel(new String[] {"Cinza Plus", "Luxury", "Austria", "Yungay Mix", "Thal\u00EDa"}));
		cmbModelos.setBounds(135, 17, 172, 22);
		getContentPane().add(cmbModelos);
		 cmbModelos.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	                String modeloSeleccionado = cmbModelos.getSelectedItem().toString();
