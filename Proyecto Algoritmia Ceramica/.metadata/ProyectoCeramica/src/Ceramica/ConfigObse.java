...
private Menu parentFrame;
	 ...
	 */
	 ...
	 String tipobs = Menu.tipoObsequio;
	...
	public ConfigObse() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Proyecto Algoritmia Ceramica\\img\\obsequio.png"));
		setTitle("Configurar cantidad \u00F3ptima");
		setBounds(100, 100, 397, 200);
		getContentPane().setLayout(null);
		
		JLabel lblTipoObsequio = new JLabel("Tipo de obsequio");
		lblTipoObsequio.setBounds(10, 11, 98, 14);
		getContentPane().add(lblTipoObsequio);
		
		JLabel lbl1a5 = new JLabel("1 a 5 unidades");
		lbl1a5.setBounds(10, 50, 86, 14);
		getContentPane().add(lbl1a5);
		
		JLabel lbl6a10 = new JLabel("6 a 10 unidades");
		lbl6a10.setBounds(10, 90, 109, 14);
		getContentPane().add(lbl6a10);
		
		JLabel lbl11mas = new JLabel("11 a m\u00E1s unidades");
		lbl11mas.setBounds(10, 130, 109, 14);
		getContentPane().add(lbl11mas);
