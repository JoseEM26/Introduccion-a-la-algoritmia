...
public class Cilindro extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent e) {     // Doble clic en botón Procesar
		...
		txtS.append("Área de la Base\t\t: " + String.format("%,8.2f",AB) + "\n");
		txtS.append("Área Lateral\t\t: " + String.format("%,8.2f",AL) + "\n");
		txtS.append("Área de Total\t\t: " + String.format("%,8.2f",AT) + "\n");
	...
	protected void actionPerformedBtnBorrar(ActionEvent e) { 	// Doble clic en botón 
