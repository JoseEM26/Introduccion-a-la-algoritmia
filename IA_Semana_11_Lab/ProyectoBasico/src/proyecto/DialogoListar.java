...
public class DialogoListar extends JDialog implements ActionListener {
	...
	protected void actionPerformedBtnListar(ActionEvent e) {
	  ...
	  imprimir("codigo\t:"+Tienda.codigo0);
	  imprimir("Titulo\t:"+Tienda.Titulo0);
	  imprimir("precio\t:"+Tienda.precio0);
	  imprimir("");
	  imprimir("codigo\t:"+Tienda.codigo1);
	  imprimir("Titulo\t:"+Tienda.Titulo1);
	  imprimir("precio\t:"+Tienda.precio1);
	  imprimir("");
	  imprimir("codigo\t:"+Tienda.codigo2);
	  imprimir("Titulo\t:"+Tienda.Titulo2);
