...
public class Arroz3 extends JFrame implements ActionListener {
	...
	// ====================================================================================================================
       ...
       double calcularImpDesc(int cantidad,double impCompra) {
    	 double impDesc;
    	   switch (cantidad) {
	   		case 1:
	   		case 2:
       ...
       double calcularImpPagar(double impCompra,double impDesc) {
    	 double impPagar;  
       ...
       int calcularGomitas(double impPagar) {

    	   int gomitas;
    	   
    	   if (impPagar < 50)
    		   gomitas = 5;
				else if (impPagar < 100)
					gomitas = 10;
				else if (impPagar < 150)
					gomitas = 15;
				else
					gomitas = 20;
       ...
       void solida(double impPago ,double impCompra, double impDesc,int Caramelos,int gomitas) {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
	    ...
	    id=calcularImpDesc(can,ic);
	    ip=calcularImpPagar(ic, id);
	    car=calcularCaramelos(mar,can);
	    gom=calcularGomitas(ip);	   
	    solida(ip, ic, id, car, gom);
