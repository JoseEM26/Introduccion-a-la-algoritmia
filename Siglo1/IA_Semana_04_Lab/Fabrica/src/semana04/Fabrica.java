...
public class Fabrica extends JFrame implements ActionListener {
	...
	//Proceso importe de compra
		...
		txtS.setText("importe de compra"+String.format("%,8.2f",impCompra)+"\n");
		txtS.append("importe descuento"+String.format("%,8.2f",impdescuento)+"\n");
		txtS.append("importe pago"+String.format("%,8.2f",impVenta)+"\n");
