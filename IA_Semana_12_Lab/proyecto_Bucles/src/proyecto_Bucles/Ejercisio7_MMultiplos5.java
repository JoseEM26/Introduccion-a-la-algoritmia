...
public class Ejercisio7_MMultiplos5 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ejercisio7_MMultiplos5 frame = new Ejercisio7_MMultiplos5();
