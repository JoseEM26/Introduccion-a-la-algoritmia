...
public class compus extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent e) {
		...
		txtS.setText("Datos" + "\n");
		txtS.append("Importe de Compra \t: S/" + String.format("%,8.2f", impcom) + "\n");
		txtS.append("Importe de Descuento \t: S/" + String.format("%,8.2f", impdes) + "\n");
		txtS.append("Importe a Pagar \t: S/" + String.format("%,8.2f", imppag) + "\n");
